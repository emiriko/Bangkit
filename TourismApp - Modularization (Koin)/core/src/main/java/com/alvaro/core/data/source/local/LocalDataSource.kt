package com.alvaro.core.data.source.local

import com.alvaro.core.data.source.local.entity.TourismEntity
import com.alvaro.core.data.source.local.room.TourismDao
